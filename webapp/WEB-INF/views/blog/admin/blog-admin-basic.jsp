	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form action="${ pageContext.request.contextPath }/${ authUser.id }/admin/editBlog" method="post" enctype="multipart/form-data">
					<table id="admin-basic">
						...
						<tr>
							...
							<td><input id="textTitle" type="text" name="blogTitle" value="${ blogAdmin.blogInfo.blogTitle }"></td>
						</tr>
						<tr>
							...
							<c:if test="${ blogAdmin.blogInfo.logoFile != null }">
								<!-- 사용자업로드 이미지 -->
								<td class="text-left"><img id="proImg" src="${pageContext.request.contextPath}/upload/${ blogAdmin.blogInfo.logoFile }"></td>
							</c:if>
						</tr>
						<tr>
							<td>&nbsp;</td>
